...
public class Objective4Lab2 {
  public static void main(String[] args) {
    ...
    int num1 = 0, num2 = 0, num3 = 0, totalInt = 0;
    double dub1 = 0, dub2 = 0, dub3 = 0, totalDub = 0;
    ...
    totalInt = num1 + num2 + num3;
    totalDub = dub1 + dub2 + dub3;

    System.out.println("The sum of " + num1 + " + " + num2 + " + " + num3 + " = " + totalInt);
    System.out.println("The sum of " + dub1 + " + " + dub2 + " + " + dub3 + " = " + totalDub);
  }
}
